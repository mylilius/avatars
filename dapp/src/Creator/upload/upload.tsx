...
const API: string = 'https://mylilius-api-test-v1.herokuapp.com';
...
const Upload = () => {
    ...
    const uploadImage = async() => {
        ...
        if (files.length > 0 && data.fileName) {
            try {
                ...
                const res = await axios.post(`${API}/avatars/media/upload`, _data, {
                    headers: {
    ...
    const uploadMetadata = async() => {
        ...
        try {
            ...
            const res = await axios.post(API + '/avatars/metadata/upload', _data, {
                    headers: {
                        'Content-Type': 'multipart/form-data'
                    }
                })
